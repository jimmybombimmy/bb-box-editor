...
export function resizeBoxWithinGrid({
  event,
  mousePos,
  rect,
  gridRect,
  ...
  if (sides.includes('left')) {
    ...
    if (
      ...
      positionDifferenceCopy.x =
        positionDifference.x - dragDifference.x + rect.width - borderWidth * 2;
    }
  ...
  if (sides.includes('top')) {
    ...
    if (
      ...
      positionDifferenceCopy.y =
        positionDifference.y - dragDifference.y + rect.height - borderWidth * 2;
    }
