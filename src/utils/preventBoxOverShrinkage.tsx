...
export const preventBoxOverShrinkage = (dragDifference: Position) => {
  const x = dragDifference.x <= boxMinimumSizePx ? boxMinimumSizePx : dragDifference.x
  const y = dragDifference.y <= boxMinimumSizePx ? boxMinimumSizePx : dragDifference.y
