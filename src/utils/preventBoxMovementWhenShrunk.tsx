...
export function preventBoxMovementWhenShrunk({positionDifferenceCopy, positionDifference, dragDifference, boxSize, sides}: PreventBoxMovementWhenShrunkPayload) {
